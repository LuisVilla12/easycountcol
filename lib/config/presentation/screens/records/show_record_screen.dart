...
class ShowRecordScreen extends StatefulWidget {
  static const String name = 'show_record_screen';
  final int idMuestra;

  const ShowRecordScreen({super.key, required this.idMuestra});

  @override
  State<ShowRecordScreen> createState() => _ShowRecordScreenState();
}
...
class _ShowRecordScreenState extends State<ShowRecordScreen> {
  ...
  Future<Map<String, dynamic>> fetchData() async {
    ...
    final record = jsonDecode(responses[2].body);
    return {
