    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
              'Ingresa la información necesaria para registar  tu cuenta'),
          const SizedBox(height: 24),
          InputCustom(
            labelInput: 'Nombre',
            hintInput: 'Ingrese el nombre',
            iconInput: const Icon(Icons.person),
            onChanged: (value) {
              name = value;
          ...
          InputCustom(
            ...
            hintInput: 'Ingrese los apellidos',
          ...
          InputCustom(
            ...
            hintInput: 'Ingrese el nombre de usuario',
          ...
          InputCustom(
              labelInput: 'Correo electronico',
              hintInput: 'Ingrese el correo electronico',
              onChanged: (value) {
                email = value;
                formKeySingin.currentState?.validate();
              },
          ...
          InputCustom(
              ...
              hintInput: 'Confirme la contraseña ingresada',
